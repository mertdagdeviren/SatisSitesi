...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  <h1 class="display-4">Bizimle İletişime Geçin</h1>
...
<div class="col-md-6 py-3 " style="margin-right: 25%;margin-left: 25%;">
    ...
    tc=Request.Querystring("tcno")
      ...
      rs.open "SELECT * FROM xx WHERE Posta='" & tc & "'",conn
    ...
    y=0
     ...
     conn.close
      ...
      %>
    <form action="iletiguncelle.asp" method="GET">
      
    
      <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Adınız ve Soyadınız</label>
          <input type="text" name="adx" value="<%Response.Write(s(1))%>" class="form-control" id="exampleInputPassword1">
        </div>
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Mail Adresiniz</label>
          <input type="email" name="mailx" value="<%Response.Write(s(2))%>" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Mesajınız</label>
            <textarea type="text" name="mesajx"  class="form-control" id="exampleInputPassword1" style="height: 400px;"><%Response.Write(s(3))%></textarea>
          </div>
