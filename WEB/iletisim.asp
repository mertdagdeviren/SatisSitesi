...
<div class="col-md-6 py-3 " style="margin-right: 25%;margin-left: 25%;">
    <form method="post" action="iletiekle.asp">
      
      <div class="mb-3">
          <label for="exampleInputPassword1" class="form-label">Adınız ve Soyadınız</label>
          <input type="text" name="adx" class="form-control" id="exampleInputPassword1">
        </div>
        <div class="mb-3">
          <label for="exampleInputEmail1" class="form-label">Mail Adresiniz</label>
          <input type="email" name="mailx" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
        </div>
        
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label">Mesajınız</label>
            <textarea type="text" name="mesajx" class="form-control" id="exampleInputPassword1" style="height: 400px;">
